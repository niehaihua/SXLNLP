...
def build_sample(tokenizer, window_size, corpus):
    ...
    # print(window, target)
    # 将字转换成序号
    x = tokenizer.encode(window, add_special_tokens=False, truncation=True, padding="max_length", max_length=10)
    y = tokenizer.encode(target, add_special_tokens=False, truncation=True, padding="max_length", max_length=10)
    return x, y
